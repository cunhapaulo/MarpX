...
<!-- ![title-bg](https://www.hs-mittweida.de/fileadmin/verzeichnisfreigaben/hsmw/studierende/bilder/campusrundgang_1_web.jpg) -->
![bg opacity:0.1](https://www.hs-mittweida.de/fileadmin/verzeichnisfreigaben/hsmw/studierende/bilder/campusrundgang_1_web.jpg)
...
# h1 Header - Ein Affe fährt die Rolltreppe hinunter

## h2 Header - Ein Affe fährt die Rolltreppe hinunter
### h3 Header - Ein Affe fährt die Rolltreppe hinunter
#### h4 Header - Ein Affe fährt die Rolltreppe hinunter
##### h5 Header - Ein Affe fährt die Rolltreppe hinunter
###### h6 Header - Ein Affe fährt die Rolltreppe hinunter
...
- When it is necessary to use only one figure and its caption, use `<figcaption>`
  &nbsp;
...
![h:400 center](./images/gods/zeus.png)
<figcaption>God Zeus</figcaption>
...
![h:350](./images/gods/zeus.png)
<span class="figcaption">God Zeus</span>

![ h:350](./images/gods/afrodite.png)
<span class="figcaption">Afrodite</span>

![ h:350](./images/gods/dionisio.png)
<span class="figcaption">Dionísio</span>

![ h:350](./images/gods/era.png)
...
|    Code    |                                   Color                                   |
| :--------: | :-----------------------------------------------------------------------: |
| `#ffb600;` | <div style="width: 50px; height: 35px; background-color: #ffb600;"></div> |
| `#A4C2F4;` | <div style="width: 50px; height: 35px; background-color: #A4C2F4;"></div> |
| `#9FC5E8;` | <div style="width: 50px; height: 35px; background-color: #9FC5E8;"></div> |
| `#C9DAF8;` | <div style="width: 50px; height: 35px; background-color: #C9DAF8;"></div> |
| `#CFE2F3;` | <div style="width: 50px; height: 35px; background-color: #CFE2F3;"></div> |
| `#f3f1ec;` | <div style="width: 50px; height: 35px; background-color: #f3f1ec;"></div> |
| `#f3f1ec;` | <div style="width: 50px; height: 35px; background-color: #f3f1ec;"></div> |
|            |                                                                           |

|    Code    |                                   Color                                   |
| :--------: | :-----------------------------------------------------------------------: |
| `#3e6ceb;` | <div style="width: 50px; height: 35px; background-color: #3e6ceb;"></div> |
| `#7389c4;` | <div style="width: 50px; height: 35px; background-color: #7389c4;"></div> |
| `#8aa1e2;` | <div style="width: 50px; height: 35px; background-color: #8aa1e2;"></div> |
| `#b8c2f9;` | <div style="width: 50px; height: 35px; background-color: #b8c2f9;"></div> |
| `#bbc7e7;` | <div style="width: 50px; height: 35px; background-color: #bbc7e7;"></div> |
| `#d8e2ec;` | <div style="width: 50px; height: 35px; background-color: #d8e2ec;"></div> |
| `#ebf0fc;` | <div style="width: 50px; height: 35px; background-color: #ebf0fc;"></div> |
|            |                                                                           |
